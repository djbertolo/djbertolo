...
I'm a Computer Science student at California State University, San Bernardino, with a minor in Data Science. My primary academic interests are in **programming languages**, **type systems**, and **static analysis**. I’m interested in understanding how language design, type theory, and mathematical structure can be used to reason about programs and make software safer.
...
For the Spring 2026 semester, my aim with my class selection is to reinforce my mathematics foundations and expand on areas of interest. I aim to expand my computer systems knowledge with coursework in Operating Systems, while studying fundamentals of mathematical theory.
